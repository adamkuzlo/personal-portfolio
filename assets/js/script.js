$(
  (function () {
    ...
    // banner text
    const texts = [
      "Sling code like a wizard",
      "Sprinkle some CSS like confetti",
      "Wrangle databases like a cowboy at a rodeo",
    ];
    const heroJob = document.querySelector(".hero-job span");
    let index = 0;

    function showNextText() {
      heroJob.textContent = texts[index];
